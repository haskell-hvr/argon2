...
foreign import ccall unsafe "argon2.h argon2i_verify" argon2i_verify :: Ptr a -> Ptr b -> (#type const size_t) -> IO (#type int)

foreign import ccall unsafe "argon2.h argon2d_verify" argon2d_verify :: Ptr a -> Ptr b -> (#type const size_t) -> IO (#type int)
